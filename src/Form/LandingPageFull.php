...
class LandingPageFull extends FormBase {
     ...
     */
     ...
     public function buildForm(array $form, FormStateInterface $form_state){
      ...
      $totalsInst = '<h3>'.ucfirst($preferred_instrument).' Elements</h3>';
      $totalsInst .= '<ul>';
      ...
      $totalsStudy = '<h3>'.ucfirst($preferred_study).' Elements</h3>';
      $totalsStudy .= '<ul>';
      ...
      $totalsStudy .=  '<li> ' . About::total('study') . ' <a href="'.Utils::selectBackUrl('study')->toString().'">'.$preferred_study.'(ies)</a></li>';
      $totalsStudy .=  '<li> ' . About::total('studyrole') . ' <a href="'.Utils::selectBackUrl('studyrole')->toString().'">'.$preferred_study.' role(s)</a></li>';
      ...
      */
      ...
      $totalsDeploy .=  '<li> ' . About::total('instrumentinstance') . ' <a href="'.Utils::selectBackUrl('instrumentinstance')->toString().'">'.$preferred_instrument.' instance(s)</a></li>';
      $totalsDeploy .=  '<li> ' . About::total('componentinstance') . ' <a href="'.Utils::selectBackUrl('deploymentinstance')->toString().'">'.$preferred_component.' instance(s)</a></li>';
