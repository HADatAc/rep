...
final class IconsExplanationForm extends FormBase {
  ...
  public function buildForm(array $form, FormStateInterface $form_state) {
    ...
    $concept_img = [
      ...
      ucfirst($preferred_study) => 'study_placeholder.png',
      ucfirst($preferred_study).' Roles' => 'studyrole_placeholder.png',
      ...
      ucfirst($preferred_component) => 'component_placeholder.png',
      ucfirst($preferred_component).' Instances' => 'component_instance_placeholder.png',
      ucfirst($preferred_component).' Stem' => 'component_stem_placeholder.png',
      ...
      ucfirst($preferred_instrument) => 'instrument_placeholder.png',
      ucfirst($preferred_instrument).' Instances' => 'Instrument_instance_placeholder.png',
    ...
    $concept_uri = [
      ...
      ucfirst($preferred_study) => 'http://hadatac.org/ont/hasco/Study',
      ucfirst($preferred_study).' Roles' => '',
      ...
      ucfirst($preferred_instrument) => 'http://hadatac.org/ont/vstoi#Instrument',
      ucfirst($preferred_component) => 'http://hadatac.org/ont/vstoi#Component',
      ucfirst($preferred_component).' Stem' => 'http://hadatac.org/ont/vstoi#ComponentStem',
    ...
    $concept_data = [
      ...
      ['name' => ucfirst($preferred_study), 'desc' => 'NOT FOUND'],
      ['name' => ucfirst($preferred_study).' Roles', 'desc' => 'NOT FOUND'],
    ...
    $concept_instance_of = [
      ...
      ucfirst($preferred_instrument) => ucfirst($preferred_instrument).' Instances',
      'Component' => ucfirst($preferred_component).' Instances',
    ];
