...
class Constant {
  ...
  const PREFIX_COMPONENT_STEM             = "CSM";
  const PREFIX_COMPONENT                  = "COM";
  const PREFIX_COMPONENT_INSTANCE         = "CIN";
  ...
  const PREFIX_WORKFLOW                   = "PC0"; // Alias for PREFIX_PROCESS
  const PREFIX_WORKFLOWSTEM               = "WST";
  const PREFIX_PROJECT                    = "PJT";
  const PREFIX_WKF                        = "WKF";
