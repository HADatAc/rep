...
> 🌐 **Portuguese version available:** [Open Portuguese version](MANUAL-PMSR-COMPLETO-PT_V2.md)
...
> **Note on PMSR terminology:** Within the PMSR context, the system's default terms may be customized by the administrator (Preferred Names). For example, "Instrument" appears as **"Simulator"**, "Platform" may appear as **"Laboratory"**, and "Study" may appear as a **"Medical Simulation Scenario"**. In these manuals we use both the technical names and the PMSR labels (e.g., Instrument/Simulator, Study/Scenario) for clarity.
...
### Relationship Diagram (including Scenarios and Workflows)

The diagram below complements the base diagram by including the link between **Studies/Scenarios** and **Workflows**.
...
- [2. Instruments / Simulators](#2-instruments--simulators)
- [3. Component Stems](#3-component-stems)
- [4. Components](#4-components)
- [5. Instrument / Simulator Instances](#5-instrument--simulator-instances)
- [6. Platforms / Laboratories](#6-platforms--laboratories)
- [7. Platform / Laboratory Instances](#7-platform--laboratory-instances)
- [8. Studies / Medical Simulation Scenarios](#8-studies--medical-simulation-scenarios)
...
## 8. Studies / Medical Simulation Scenarios
...
**PMSR context:** Workflows define executable processes/tasks within Scenarios (Studies)
...
*Documentation created for the PMSR Working Group - April 2026 (Version 2.0)*
