...
> 🌐 **Versão em inglês disponível:** [Open English version](MANUAL-PMSR-COMPLETO-EN_V2.md)
...
### Diagrama de Relação (incluindo Cenários e Workflows)

O diagrama abaixo complementa o diagrama base, incluindo a ligação entre **Studies/Cenários** e **Workflows**.
...
![PNG do diagrama: Diagrama de Relação (incluindo Cenários e Workflows)](images/diagrams/pt/d39-diagrama-de-relacao-incluindo-cenarios-e-workflows.png)
> _Imagem PNG equivalente ao diagrama Mermaid acima. Coloque o ficheiro com este nome em docs/images/diagrams/pt/._
...
- [5. Instâncias de Instruments / Simulators](#5-instâncias-de-instruments--simulators)
- [6. Platforms / Laboratories](#6-platforms--laboratories)
- [7. Instâncias de Platforms / Laboratories](#7-instâncias-de-platforms--laboratories)
- [8. Studies / Cenários de Simulação Médica](#8-studies--cenários-de-simulação-médica)
...
## 8. Studies / Cenários de Simulação Médica
...
*Documento do Grupo de Trabalho PMSR - Abril 2026 (Versão 2.0)*
